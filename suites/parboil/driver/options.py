...
def compile_options(progname, cmd, args):
    help_string = "usage :" + progname + " compile BENCHMARK VERSION [SASSI_OPTION=none] [PLATFORM=default]\nCompile version VERSION of BENCHMARK [for platform PLATFORM]"
    ...
    def run():
        ...
        if not len(pos) in [2, 3, 4]:
            ...
            try:
              ...
              sassi_option = None
            return lambda: actions.with_benchmark_named(bmkname, lambda b: actions.compile_benchmark(b, ver, sassi_option, platform))
