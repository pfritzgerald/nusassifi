...
diff --side-by-side --suppress-common-lines -W 1024 ${APP_DIR}/result.txt result.txt > diff.log
# comparing stdout generated by your program

diff --side-by-side --suppress-common-lines -W 1024 <(sed 's/:::Injecting.*::://g' stdout.txt) ${APP_DIR}/golden_stdout.txt > stdout_diff.log
