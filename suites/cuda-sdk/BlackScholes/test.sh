...
if [ `hostname -s` == "kepler1" ]; then
	export SASSIFI_HOME=/home/ckalra/sassifi/
	export SASSI_SRC=/home/ckalra/SASSI/
	export INST_LIB_DIR=$SASSI_SRC/instlibs/lib/
	export CCDIR=/usr/bin/
	export CUDA_BASE_DIR=/home/ckalra/sassi7/
...
# multiple targets. 
python $SASSIFI_HOME/scripts/process_kernel_regcount.py atomic_add sm_35 stderr.txt
